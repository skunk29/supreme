    ...
    $.fn.scrollWithEase = function(e) {
        !function() {
            ...
            function a() {
                if (document.body) {
                    var e = document.body
                      ...
                      , r = e.scrollHeight;
                    if (H = document.compatMode.indexOf("CSS") >= 0 ? a : e,
                    g = e,
                    t(),
                    D = !0,
                    top != self)
                    ...
                    y.fixedBackground || S || (e.style.backgroundAttachment = "scroll",
                ...
                !A) {
                    var l = e === document.body
                      , c = function() {
                        ...
                        l ? window.scrollBy(n, i) : (n && (e.scrollLeft += n),
                        i && (e.scrollTop += i)),
                        t || a || (z = []),
                        z.length ? K(c, e, o / y.frameRate + 1) : A = !1
                    };
                    K(c, e, 0),
                    A = !0
                }
            ...
            function r(e) {
                ...
                var t = e.target
                  , r = c(t);
                if (!r || e.defaultPrevented || d(g, "embed") || d(t, "embed") && /\.pdf/i.test(t.src))
                    return !0;
                var n = e.wheelDeltaX || 0
                  , i = e.wheelDeltaY || 0;
                return n || i || (i = e.wheelDelta || 0),
                !(y.touchpadSupport || !p(i)) || (Math.abs(n) > 1.2 && (n *= y.stepSize / 120),
            ...
            function n(e) {
                ...
                if (/input|textarea|select|embed/i.test(t.nodeName) || t.isContentEditable || e.defaultPrevented || a)
                    return !0;
                if (d(t, "button") && e.keyCode === T.spacebar)
                    return !0;
                var r, n = 0, i = 0, l = c(g), u = l.clientHeight;
            ...
            function h(e) {
                ...
                1 > e ? t = e - (1 - Math.exp(-e)) : (a = Math.exp(-1),
                e -= 1,
                o = 1 - Math.exp(-e),
                t = a + o * (1 - a)),
                t * y.pulseNormalize
            ...
            function w(e) {
                return e >= 1 ? 1 : 0 >= e ? 0 : (1 == y.pulseNormalize && (y.pulseNormalize /= h(1)),
                h(e))
            }
            var g, v = $.extend({
                frameRate: 60,
                ...
                x: 0,
                y: 0
            }, D = !1, H = document.documentElement, M = [120, 120, 120], T = {
                left: 37,
                up: 38,
                right: 39,
                down: 40,
            ...
            }(), L = /chrome|iPad/i.test(window.navigator.userAgent), R = "onmousewheel"in document;
            R && L && (u("mousedown", i),
            u("mousewheel", r),
            u("load", a))
        }()
